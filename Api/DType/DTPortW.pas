...
function TDynOutPortIndent.WriteFloat(v: Single): Boolean; stdcall;                                                              begin Result := Port.WriteFloat(v); end;
function TDynOutPortIndent.WriteFloat(v: Double): Boolean; stdcall;                                                              begin Result := Port.WriteFloat(v); end;
